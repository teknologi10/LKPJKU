...
<head>
    ...
    <title>Admin JDIH DPRD | Kabupaten Kulon Progo</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="<?= base_url('img/logojdih.ico'); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?php if ($aktif == 'profil') {
                                                echo "has-treeview menu-open";
                                            } ?>">
                            <a href="<?= base_url(); ?>/profil/tampil" class="nav-link">
                        ...
                        <li class="nav-item <?php if ($aktif == 'raperda') {
                            ...
                            <a href="<?= base_url(); ?>/risalah/tampil" class="nav-link">
                                <i class="nav-icon fas fa-book"></i>
                                <p>
                                    Risalah Rapat
                                </p>
