                                ...
                                <li class="product-nicescroll-bar row">
                                    <ul class="pa-20">
                                        <li class="col-md-3 col-xs-6 col-menu-list">
                                            <a href="index.html">
                                                <div class="pull-left"><i class="ti-dashboard  mr-20"></i><span class="right-nav-text">Analytical</span></div>
                                                <div class="clearfix"></div>
                                            </a>
                                            <a href="index2.html">
                                                <div class="pull-left"><i class="ti-money  mr-20"></i><span class="right-nav-text">Cryptocurrency</span></div>
                                                <div class="pull-right"><span class="label label-success">Hot</span></div>
                                                <div class="clearfix"></div>
                                            </a>
                                            <a href="profile.html">
                                                <div class="pull-left"><i class="ti-briefcase  mr-20"></i><span class="right-nav-text">Profile</span></div>
                                                <div class="clearfix"></div>
                                            </a>
                                        </li>
                                        <li class="col-md-3 col-xs-6 col-menu-list">
            ...
            <ul class="nav navbar-nav side-nav nicescroll-bar">
                ...
                <li>
                    <a href="<?= base_url(); ?>/tanggapan">
                        <div class="pull-left"><i class="ti-book mr-20"></i><span class="right-nav-text">tanggapan rekomendasi</span></div>
                        <div class="clearfix"></div>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url(); ?>/verifikasi">
                        <div class="pull-left"><i class="ti-book mr-20"></i><span class="right-nav-text">verifikasi tanggapan OPD</span></div>
                        <div class="clearfix"></div>
                    </a>
                </li>
            </ul>
