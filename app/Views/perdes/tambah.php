                ...
                <div class="col-md-12">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class=" card-title">Tambah Peraturan Desa</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="/perdes/save" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control <?= ($validation->hasError('desa')) ? 'is-invalid' : ''; ?>" style="width: 100%;" name="desa">
                                                <option selected="selected" value="">--Pilih Desa--</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>Tentang</label>
                                            <textarea class="form-control" rows="4" placeholder="Enter ..." name="tentang"><?= old('tentang'); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" placeholder="Enter ..." name="ket"><?= old('ket'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="lamp" name="lamp">
