                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header" style="background:#182C61">
                            <h3 class="card-title">Tambah Naskah Akademik</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->

                        <form role="form" action="<?= base_url(); ?>/naskah_akademik/save" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input <?= ($validation->hasError('naskah')) ? 'is-invalid' : ''; ?>" id="naskah" name="naskah"><br>
                                                    <div class="error invalid-feedback">
                                                        <?= $validation->getError('naskah'); ?>
                                                    </div><br>
                                                    <label class="custom-file-label" for="naskah">Pilih dokumen</label>
                                                </div>
