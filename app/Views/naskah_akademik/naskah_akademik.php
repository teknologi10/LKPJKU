        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="breadcrumb_content">
                    <h2 class="breadcrumb_title">NASKAH AKADEMIK</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Beranda</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Naskah Akademik</li>
                    </ol>
                    <div class="wrapper">
        ...
        <div class="row">
                        ...
                        <div class="for_blog list-type feat_property" style="width: 100%;">
                            ...
                            <div class="details pb5">
                                <div class="tc_content pt15">
                                    ...
                                    <h4 class="mt15 mb20"><a href="<?= base_url(); ?>/peraturan/naskah_akademik/<?= $n['file']; ?>" target="_blank">
                                            <?= $n['judul']; ?>
                                        </a></h4>
            ...
            <div class="col-lg-4 col-xl-4">
                <div class="terms_condition_widget">
                    <h4 class="title">NASKAH AKADEMIK TERBARU</h4>
                    <div class="widget_list">
                        <ul class="list_details order_list list-style-type-bullet">
                            <?php foreach ($terbaru as $t) : ?>
                                <li><a href="<?= base_url(); ?>/peraturan/naskah_akademik/<?= $t['file']; ?>" target="_blank">
                                        <?= $t['judul']; ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
